...
<head>
	...
	<script type="text/javascript">
		...
		function UpladFile() {
			...
			if((fileObj.size/1024 > 1025 ) && (suffix=="BMP"||suffix=="JPG"||suffix=="JPEG"||suffix=="PNG"||suffix=="GIF")) { //大于1M,并且是图片类，进行压缩上传
...
<br /><br />
<!--图片上传：<input type="file" id="file" name="myfile" accept="image/x-png, image/jpg, image/jpeg, image/gif"/><br/>-->
文件上传：<input type="file" id="file" name="myfile"  />
